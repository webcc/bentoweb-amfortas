...
<!-- CVS $Id: welcome.xslt,v 1.2 2005/12/13 21:12:47 velasco Exp $ -->
  ...
  <xsl:template match="welcome">
    <html xml:lang="en" lang="en">
      ...
      <body>
        ...
        <xsl:apply-templates/>
        <p class="copyright">
         Copyright © 1999-2005 <a href="http://www.apache.org/">The Apache Software Foundation</a>. All rights reserved.
        </p>
        <p class="block">
